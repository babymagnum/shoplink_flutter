...
class ThemeTextStyle {
  ...
  /// Ubuntu
  static const TextStyle ubuntuBold = TextStyle(
  ...
  static const TextStyle ubuntuMedium = TextStyle(
    fontFamily: Fonts.ubuntu,
  ...
  /// OpenSans
  static const TextStyle openSansExtraBold = TextStyle(
    fontFamily: Fonts.openSans,
    fontWeight: Fonts.openSansExtraBold,
    fontSize: 0,
    color: ThemeColor.black1,
  );
  ...
  static const TextStyle openSansSemiBold = TextStyle(
    fontFamily: Fonts.openSans,
    fontWeight: Fonts.openSansSemiBold,
    fontSize: 0,
    color: ThemeColor.black1,
  );
  ...
  /// Neusa font
  static const TextStyle neusaBold = TextStyle(
    fontFamily: Fonts.neusa,
    fontWeight: Fonts.neusaBold,
    fontSize: 0,
    color: ThemeColor.black1,
  );

  static const TextStyle neusaRegular = TextStyle(
    fontFamily: Fonts.neusa,
    fontWeight: Fonts.neusaRegular,
    fontSize: 0,
    color: ThemeColor.black1,
  );

  static const TextStyle neusaLight = TextStyle(
    fontFamily: Fonts.neusa,
    fontWeight: Fonts.neusaLight,
    fontSize: 0,
    color: ThemeColor.black1,
  );
}
